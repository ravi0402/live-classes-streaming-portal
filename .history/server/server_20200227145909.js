...
const { CONTROLLER_URL, API_KEY, API_SECRET } = process.env;

const adminApis = require("./controllerIf");
const newAdmin = new adminApis(CONTROLLER_URL, API_KEY, API_SECRET);

app.get("/create-session/", (req, res) => {
  newAdmin.createSession({ mediaMode: "routed", duration: 3600 }).then(newSessionId => {
